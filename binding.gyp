  ...
  "targets": [
    {
      ...
      "sources": [ 
        ...
        "src/source/wrapped/reset.cpp",
        "src/source/wrapped/rotate.cpp",
        "src/source/wrapped/rpd.cpp",
        "src/source/wrapped/sigerr.cpp",
      ...
      "conditions": [
        ...
        ['OS=="mac"', {
          "defines": [ 'NAPI_DISABLE_CPP_EXCEPTIONS', 'NON_UNIX_STDIO' ],
          "libraries": [ "<(project_root)/src/cspice/osx/cspice/lib/cspice.a" ],
          "link_settings": {
                'library_dirs': [
