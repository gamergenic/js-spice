...
having constant velocity in a specified reference frame.',
    ...
    async function() {
        ...
        const {state, lt} = spice.spkcvt({r:[1,1,1],v:[0,0,0]}, spice.str2et("2023 DEC 30"), "mercury", "J2000", spice.str2et("2023 DEC 30"), "J2000", "OBSERVER", "NONE", "EARTH");
